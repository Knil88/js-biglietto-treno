...
//output
    ...
    document.getElementById("title").innerHTML = `Lei percorrerà ${route} chilometri , ma dato che non può usufruire id alcuno sconto il prezzo del biglietto sarà quello base che ammonta a ${ticketPrice}€`;
}
